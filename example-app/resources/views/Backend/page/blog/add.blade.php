        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="">Thêm bài viết</h2>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <form id="add_blog" action="{{ route('admin.blog.saveadd') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="view_blog" id="" class="form-control" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="mainimg_blog" id="" class="form-control" placeholder="">
                                        @error('mainimg_blog')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="typeblog_id" id="">
                                            @foreach ($typeBlogs as $typeBlog)
                                                <option value="{{ $typeBlog->id_type_blog }}">{{ $typeBlog->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="conten_blog" id="" style="width:100%"
                                    rows="5"></textarea>
                                @error('conten_blog')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
