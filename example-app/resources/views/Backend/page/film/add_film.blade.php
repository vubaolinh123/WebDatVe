                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="cast" type="text" class="form-control  " placeholder="Tên phim">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="summary" id="" style="width:100%" rows="10"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="deleted" id="">
                                            <option value="0">Còn chiếu</option>
                                            <option value="1">Đã gỡ</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
