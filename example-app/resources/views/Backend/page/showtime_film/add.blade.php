        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="">Thêm thời gian chiếu phim</h2>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <form id="add_showdate" action="{{ route('admin.timeshowfilm.saveadd') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" min="" name="show_date" id="show_date" class="form-control"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="film_id" id="">
                                            ...
                                            @foreach ($films as $film)
                                                <option value="{{ $film->id_film }}">{{ $film->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
