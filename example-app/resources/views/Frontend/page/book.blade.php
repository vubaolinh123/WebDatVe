    ...
    <div style="padding: 20px 0" class="row">
        <div class="col-xs-8">
            <div class="main">
                ...
                <div class="table-film">
                            ...
                            @foreach ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="input-type">
                                        ...
                                        <input data-id="{{ $ticket->id_price_ticket }}" data-type="ticket" name="s1"
                                            class="sl_{{ $ticket->id_price_ticket }}" type="number" min="0"
                                            value="@phpif (session()->has('book1')) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 if ($key == 'ticket') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    foreach ($value as $k => $v) {echo $v;} }; }} } else {echo 0; } @endphp ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?>"
                                            name="s1">
                                        <span class=" input-booking">
                                ...
                                @if ($food->type_food->id_type_food == 3)
                                    <tr style="text-align: center;">
                                        ...
                                        <td class="input-type">
                                            ...
                                            <input data-id="{{ $food->id_food }}" data-type="food" class="sl"
                                                type="number" min="0"
                                                value="@phpif (session()->has('book1')) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           foreach (session()->get('book1') as $key => $value) {if ($key == 'food') {  foreach ($value as $k => $v) { if ($k == $food->id_food) { echo $v; } }; } } } else {echo 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          } @endphp ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?>"
                                                name="s1">
                                            <span class=" input-booking">
                                                <button>
                    ...
                    <table id="table-combo" class=" table table-hover">
                        <thead>
                            <th>Đồ ăn & đồ uống</th>
                            <th style="text-align: center;">Số lượng</th>
                            <th style="text-align: right;">Giá (VNĐ)</th>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td class="input-type">
                                            ...
                                            <input data-id="{{ $food->id_food }}" data-type="food" class="sl"
                                                type="number" min="0"
                                                value="@phpif (session()->has('book1')) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          foreach (session()->get('book1') as $key => $value) {  if ($key == 'food') {foreach ($value as $k => $v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    if ($k == $food->id_food) { echo $v;}}; } } } else { echo 0; } @endphp ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?>"
                                                name="s1">
                                            <span class=" input-booking">
                                                <button>
                                                    <span>
        ...
        <div class="col-xs-4">
            <div class="detail-film">
                <div class="img-film"
                    style="background-image: url({{ asset("$URL_IMG_FILM/" . $show_time->film->avatar) }} )">

                    <div class="detail-conten_film">

                        <p class=" p-10 text-bold">{{ $show_time->film->name }}</p>
