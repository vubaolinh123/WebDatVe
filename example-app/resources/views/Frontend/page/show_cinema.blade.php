    ...
    <div class="bg">
        ...
        <div class="cont row">
            ...
            <div class="col-sm-2 text-center">
                @if ($numStart == 0 && $countStart == 0)
                 <p> Chưa có đánh giá</p>
                 @else
                 <div style=" overflow:hidden ; padding : 13px ;border : 5px solid #5bc0de ; width : 150px ; height : 150px ; border-radius : 50%">
                     <p style="font-size : 50px ; color :#5bc0de ; font-weight : bold" class="text-center">{{  round($numStart/$countStart) ?? 0  }} <i
                                                ...
                                                @foreach ($item->cinema_room as $cinema_room)
                                                    @foreach ($cinema_room->show_time as $showtime)
                                                        @if ($showtime->show_date >= \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toDateString())
                                                            ...
                                                            <p> <a href="{{ route('web.book', ['id' => $showtime->id_showtime]) }}"
