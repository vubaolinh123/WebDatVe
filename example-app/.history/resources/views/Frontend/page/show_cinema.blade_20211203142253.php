...
@section('conten.web')
    ...
    <div class="bg">
        ...
        <div class="cont row">
            ...
            <div class="col-sm-2 text-center" >Đánh giá : <br>
                <div style=" overflow:hidden ; padding : 13px ;border : 3px solid #5bc0de ; width : 130px ; height : 130px ; border-radius : 50%">
                    <p style="font-size : 50px ; color :#5bc0de ; font-weight : bold" class="text-center">{{  round($numStart/$countStart)  }} <i
