...
@section('conten.web')
                            ...
                            <div class="col-xs-2 mb-5">
                                <div class="item-film">
                                    ...
                                    <a style="position: relative"
                                        ...
                                        <div data-id="{{ $filmHomeDeleted0 -> id_film }}" class="film_img film_img_{{ $filmHomeDeleted0 -> id_film }}"
                                            style="background-image: url({{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }})">
                                        </div>
                                        @if ($filmHomeDeleted0 -> trailer)

                                        <iframe   class="i-f-h frame_{{ $filmHomeDeleted0 -> id_film }}" style="display: none" width="100%" height="300"
                                            ...
                                            ></iframe>
                                        @else
                                        <div   class="i-f-h frame_{{ $filmHomeDeleted0 -> id_film }}" style="display: none" width="100%" height="300"

                                            >No trailer</div>
                                        @endif
                                        <a
                                                    class="i-f-l links_{{ $filmHomeDeleted0 -> id_film }}"
                                                    href="{{ route('web.detailFim', ['id_film' => $filmHomeDeleted0->id_film, 'slug' => \Str::slug($filmHomeDeleted0->name)]) }}"
    ...
    <div class="cinema-area">
        <div class="tabs">
            <button class="tablinks active"  >Các rạp </button>
            <button class="tablinks" >Phim sắp chiếu</button>
        </div>
    </div>
