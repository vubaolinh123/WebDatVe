                ...
                <div class="col-span-2">
                    ...
                    <div class="py-5">
                        ...
                        <div class="grid grid-cols-3 gap-5">
                            ...
                            <p class="btn" value="">Hiện tại không có rạp!</p>
                            @else
                                <div class="">
                    ...
                    <div class="">
                        @if (count($cinemaOfFilms) == 0)
                            <img width="100%" src="https://i1.wp.com/www.huratips.com/wp-content/uploads/2019/04/empty-cart.png?fit=603%2C288&ssl=1" alt="">
                        @else
                            @foreach ($cinemaOfFilms as $cinemaOfFilm)
                                <div class="py-5">
                                    <span
