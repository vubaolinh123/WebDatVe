...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="alert alert-warning">Lưu ý : Hóa đơn sẽ được gửi đến email tài khoản của của khách hàng để tránh trường hợp spam , khách hàng mua hóa đơn mang hóa đơn online đến để xem phim ! <br>  Cảm ơn quý khách</p>
            </div>
            ...
            <h3 style="display: inline" class="bg-primary text-light p-3">Tổng : <?= number_format($prFoods + $prTicket) ?> VND <br> Thanh toán :<div id="paypal-button"></div></h2>
            ...
            <script>
                paypal.Button.render({
                  ...
                  env: 'sandbox',
                  client: {
                    sandbox: 'AQaeBfm3iii0c0M8cqxg_AecpeokObwqhYgwwiNcDt1TBbEd-QKZYIwjWheaH8zfovPc0N8ZDkchABUz',
                  ...
                  onAuthorize: function(data, actions) {
                    return actions.payment.execute().then(function() {
                      ...
                      window.alert('Đơn hàng đã được xác nhận , hóa đơn sẽ được gửi đến quý khách , Cảm ơn quý khách ');
                      window.location = '/pay-success/{{ $id }}';
                    });
                  }
                }, '#paypal-button');
