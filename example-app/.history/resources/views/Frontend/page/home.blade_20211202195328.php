...
@section('conten.web')
    <div style="height:600px ; width : 100% " class="">
        ...
        <div  style="background : black ; overflow: hidden" class="swiper mySwiper">
            <div class="swiper-wrapper">
                @foreach ($filmHomeDeleted0s as $filmHomeDeleted0)
                    <div   style="width: 60% ; height : 500px ; border-radius : 20px;  box-shadow: 1px 1px 25px rgb(250, 250, 250) ;  position: relative;" class="swiper-slide">
