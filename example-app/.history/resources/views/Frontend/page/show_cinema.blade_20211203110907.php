                ...
                <div id="menu2" class="tab-pane fade ">
                    <div class="row p-3">
                        ...
                        <div class="col-sm-3 p-3">
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                <button data-i="{{ $i }}" class="btn btn-st btn-{{ $i }} btn-primary">{{ $i }} <i class="fas fa-star"></i></button>
                            @endfor
                        </div>
                        <div class="col-sm-2 p-3"><button data-id_cinema="{{ $cinema -> id }}" id="comment_start" class="btn btn-success">Bình luận</button></div>
                    </div>
                    <div style="border: 1px solid black ;border-radius: 10px" class="show_binhluan container-fluid m-3 border border-primary p-4"></div>
                </div>
            </div>
