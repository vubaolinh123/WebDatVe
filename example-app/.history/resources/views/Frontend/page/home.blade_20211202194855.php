...
@section('conten.web')
    <div style="height:600px ; width : 100% " class="slideshow">
        <style>
            a{
                position: absolute;
        ...
        <div  style="background : black ;" class="swiper mySwiper">
            <div class="swiper-wrapper">
                @foreach ($filmHomeDeleted0s as $filmHomeDeleted0)
                    <div   style="width: 60% ; height : 500px ;   box-shadow: 2px 2px 20px rgb(250, 250, 250) ;  position: relative;" class="swiper-slide">
                        ...
                        <div style="
                            ...
                            position: absolute;">
                                ...
                                <small style="color : rgb(44, 44, 44)">
