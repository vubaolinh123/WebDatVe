...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <p>Mã hóa đơn : {{ uniqid() . time() }}</p>
            <p class="alert alert-warning">Lưu ý :Hóa đơn sẽ được gửi đến email số tài khoản của của khách hàng để tránh trường hợp spam , khách hàng mua hóa đơn mang hóa đơn online đến để xem phim ! <br>  Cảm ơn quý khách</p>
            </div>
