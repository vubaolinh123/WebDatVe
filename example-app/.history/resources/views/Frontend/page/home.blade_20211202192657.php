...
@section('conten.web')
    <div style="height:500px" class="slideshow">

        <div  style="height:500px" class="swiper mySwiper">
            <div class="swiper-wrapper">
                @foreach ($filmHomeDeleted0s as $filmHomeDeleted0)
                    <div   class="swiper-slide">
                        {{-- <div style="width: 60% ; height : 500px" class="swiper-slide"> --}}
                        <img src="{{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }}" />
                    </div>
                @endforeach
            </div>
