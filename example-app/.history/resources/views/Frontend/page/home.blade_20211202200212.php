...
@section('conten.web')
    <div style="height:600px ; width : 100% " class="">
       {{-- <style>
        a{
        ...
        <div  style="background : black ; " class="swiper mySwiper">
            <div class="swiper-wrapper">
                @foreach ($filmHomeDeleted0s as $filmHomeDeleted0)
                    <div   style="width: 60% ; height : 500px ; overflow: hidden;border-radius : 20px;  box-shadow: 1px 1px 25px rgb(250, 250, 250) ;  position: relative;" class="swiper-slide">
                        <img style="height:100% ; width : 40% ; top : 0 ; left:0; position: absolute;"  src="{{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }}" />
                        <img style="height:100% ; width : 60% ; top : 0  ; opacity : .3; right:0; position: absolute;"  src="{{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }}" />
                        <div  style="transform : z-index:3; translate(-50% , -50%);height:100% ; width : 60% ; top : 50%  ;  left : 50%; position: absolute;" > <i style="width: 200px;height : 200px" class="far fa-play-circle"></i></div>
                        <div style="
                            color : white ;
    ...
    <div style="padding: 0 32px ; margin : 0 auto ; width : 90%" class="cinema-area">
        ...
        @foreach ($clusterCinema as $cluster)
            ...
            <a href="{{ route('web.show.cinema' , [ 'id' => $item -> id , 'slug' => \Str::slug($item->name) ]) }}" style="padding:20px ; margin : 0 auto" class="row">
                <div class="col-sm-1">
                    <img style="width:60px ; height : 60px ; border-radius:50%"  src="{{ URL::to('storage/' . $item->image) }}" alt="">
                </div>
                <div class="col-sm-10">
                    <h3>
                        {{ $item -> name }}
