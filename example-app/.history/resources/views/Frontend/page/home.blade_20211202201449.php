            ...
            <div class="swiper-wrapper">
                @foreach ($filmHomeDeleted0s as $filmHomeDeleted0)
                    <div style="width: 60% ; height : 500px ; overflow: hidden;border-radius : 20px;  box-shadow: 1px 1px 25px rgb(250, 250, 250) ;  position: relative;"
                        class="swiper-slide">
                        <img class="showImgSli_{{ $filmHomeDeleted0->id_film }}" style="height:100% ; width : 40% ; top : 0 ; left:0; position: absolute;"
                            src="{{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }}" />

                            <iframe class="showVido_{{ $filmHomeDeleted0->id_film }}"  style="display: none;height:100% ; width : 40% ; top : 0 ; left:0; position: absolute;" class="i-f-h  {{ $filmHomeDeleted0->id_film }}"
                        ...
                        <div
                           ...
                           <button class="btn-hv btn-click-slide" style="width : 100px">
