                ...
                <div class="col-span-2">
                    ...
                    <div class="py-5">
                        ...
                        <div class="grid grid-cols-3 gap-5">
                            ...
                            <div class="">
                                <input type="date" value="{{ $_GET['date'] ?? \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toDateString() }}" id="date_change"
                                            ...
                                            @if ($cinemaRoom->cinema_id == $cinemaOfFilm->id)
                                                <div class="mb-12 m-2">
                                                    ...
                                                    @foreach ($cinemaRoom->show_time as $time)
                                                        ...
                                                        || $time->show_date = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toDateString()
                                                        && $film->id_film == $time->film_id
                                                        && $time->start_time >= \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toTimeString()
                                                        )
                                                            <a href="{{ route('web.book', ['id' => $time->id_showtime]) }}"
