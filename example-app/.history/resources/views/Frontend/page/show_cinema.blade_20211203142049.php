...
@section('conten.web')
    ...
    <div class="bg">
        ...
        <div class="cont row">
            ...
            <div class="col-sm-2 ">Đánh giá : <br>
                <div style="padding:5px ; border : 1px solid #5bc0de ; width : 130px ; height : 130px ; border-radius : 50%">
                    <h3 style="font-size : 50px ; color :#5bc0de ; font-weight : bold" class="text-center">{{  round($numStart/$countStart)  }} <i
