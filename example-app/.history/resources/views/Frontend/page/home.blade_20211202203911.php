...
<style>
    ...
    <div style="height:600px ; width : 100% ; position: relative;" class="">
        ...
        <div
            ...
            width : 70% ;
            height : 50px ; background : rgb(255, 255, 255) ;
            left: 50%;
            transform:  translate(-50% , -50%);
            bottom: -100px ; z-index:3 ; border-radius : 10px ; padding :10px ; display : grid ;    grid-template-columns: 1fr 1fr 1fr 1fr "
        >
            ...
            <div>
                <button class="btn btn-primary">Mua ve</button>
            </div>
            {{-- <div>
                <select class="  form-control" name="" id="">
                    <option value="">ABC</option>
