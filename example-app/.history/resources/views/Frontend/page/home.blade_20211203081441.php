                ...
                <div class="col-sm-3">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        {{-- @foreach ($cluster->cinema as $key => $item) --}}
                            ...
                            {{-- href="{{ route('web.show.cinema', ['id' => $cluster->id, 'slug' => \Str::slug($cluster->name)]) }}" --}}
                                style=" display: grid ;  grid-template-columns:  100px 1fr ; gap :10px ; margin:20px" >
                                <div >
                                    <img style="width:60px ; height : 60px ; border-radius:50%"
