                            ...
                            <div class="col-xs-2 mb-5">
                                <div class="item-film">
                                    <a
                                        ...
                                        <div data-id="{{ $filmHomeDeleted0 -> id_film }}" class="film_img"
                                            style="background-image: url({{ asset("$URL_IMG_FILM/$filmHomeDeleted0->avatar") }})">
                                        </div>
                                        <iframe class="frame" style="display: none" width="100%" height="300" src="https://www.youtube.com/embed/odM92ap8_c0"
