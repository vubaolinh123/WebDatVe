                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                            data-autoclose="true">
                            <input wire:model="time_open" type="time" class="form-control" value="13:14"> <span
                                class="input-group-append"><span class="input-group-text"><i
                                        class="fa fa-clock-o"></i></span></span>
                        </div>
                        <x-error field="time_open" class="text-danger" />{{ $time_open }}
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                            data-autoclose="true">
                            <input wire:model="time_close" type="time" class="form-control" value="13:14"> <span
                                class="input-group-append"><span class="input-group-text"><i
                                        class="fa fa-clock-o"></i></span></span>
                        </div>
