            ...
            @if ($flag)
                ...
                <div class="col-xl-5">
                    <div class="form-group">
                        ...
                        <input wire:model="phone"  name="name" type="number" class="form-control  " placeholder="Điện thoại liên hệ">
                        <x-error field="name" class="text-danger" />
                    </div>
                </div>
                <div class="col-xl-7">
                ...
                <div class="col-xl-3">
                    <div class="form-group">
                        ...
                        <input wire:model="image"  type="file" name="logo" id="" class="form-control" onchange="onChangeImg(this)">
                ...
                <div class="col-xl-8">
                    <div class="form-group">
                        ...
                        <textarea   wire:model="address" style="width:100%"
                            rows="10"></textarea>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group">
                        ...
                        <textarea wire:model="detail"   style="width:100%"
                            rows="10"></textarea>
                    </div>
                </div>
            @endif
