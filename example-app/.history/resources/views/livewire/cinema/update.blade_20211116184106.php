            ...
            @if ($flag)
                ...
                <div class="col-xl-3">
                    <div class="form-group">
                        ...
                        <br>
                        <img scr="{{ URL::to('storage/'. $cinema -> image) }}" style="display:none;width:200px ; height : 200px ; border-radius:50%" id="showImg">
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                            data-autoclose="true">
                            <input wire:model="cinema_open" type="text" class="form-control" value="13:14"> <span
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                            data-autoclose="true">
                            <input wire:model="cinema_close" type="text" class="form-control" value="13:14"> <span
                                class="input-group-append"><span class="input-group-text"><i
                                        class="fa fa-clock-o"></i></span></span>
                        </div>
