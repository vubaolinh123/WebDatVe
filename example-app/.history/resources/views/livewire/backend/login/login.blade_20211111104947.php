        ...
        <div class="modal-dialog  login animated">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" wire:click="resetD" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        ...
                        <div class="content">
                            ...
                            <div e class="form loginBox">
                                <form  method="post" wire:submit.prevent="loginAdmin"   accept-charset="UTF-8">
                                    <input wire:model="email" id="email" class="form-control" type="text" placeholder="Email"
                                        name="email">
                                    <x-error field="email" class="alert alert-danger" />
                                    <input wire:model="password" id="password" class="form-control" type="password" placeholder="Password"
                                        name="password">
