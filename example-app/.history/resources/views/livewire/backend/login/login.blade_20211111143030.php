                        ...
                        <div class="content">
                            <div e class="form loginBox">
                                <form method="post" wire:submit.prevent="checkCode"  >
                                    ...
                                    <button wire:click.prevent="clickSendCode" class="btn m-3 btn-danger">Send Code</button>
                                    <button wire:loading wire:target="clickSendCode" class="btn m-3 btn-danger">Đang gửi mã ...</button>
