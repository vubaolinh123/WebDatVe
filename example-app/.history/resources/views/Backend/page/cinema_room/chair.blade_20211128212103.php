                        ...
                        <tbody>
                            ...
                            @foreach ($cinemarooms as $cinemaroom)
                                <tr>
                                    ...
                                    <td>
                                        <select data-id="{{ $cinemaroom->id_cinema_room }}" data-type="col" data-size="start" class="form-control changeChair" >
                                    ...
                                    <td>
                                        <select data-id="{{ $cinemaroom->id_cinema_room }}" data-type="col" data-size="end" class="form-control changeChair" >
                                    ...
                                    <td>
                                        <select data-id="{{ $cinemaroom->id_cinema_room }}" data-type="row" data-size="start" class="form-control changeChair" >
                                    ...
                                    <td>
                                        <select data-id="{{ $cinemaroom->id_cinema_room }}" data-type="row" data-size="end" class="form-control changeChair" >
