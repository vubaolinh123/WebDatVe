                        ...
                        <tbody>
                            ...
                            @foreach ($cinemarooms as $cinemaroom)
                                <tr>
                                    ...
                                    <td>
                                        <select data-type="col" class="form-control" >
                                    ...
                                    <td>
                                        <select data-type="col" class="form-control" >
                                            <option value="">Chọn cột kết thúc dãy ghế vip</option>
                                            @for ($i = 1; $i <= $cinemaroom->quantity_row; $i++)
                                            <option value="{{ $i }}">{{ $i }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <td>
                                        <select data-type="col" class="form-control" >
                                            <option value="">Chọn cột bắt đầu hàng ghế vip</option>
                                    ...
                                    <td>
                                        <select data-type="col" class="form-control" >
                                            <option value="">Chọn cột kết thúc hàng ghế vip</option>
                                            @for ($i = 1; $i <= $cinemaroom->quantity_col; $i++)
                                            <option value="{{ $i }}">{{ $i }}</option>
                                            @endfor
                                        </select>
