                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form id="add_cr" autocomplete="off" action="{{ route('admin.cinemaroom.addSave') }}"
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <select  class="form-control"  name="cinema_id" id="">
                                        @foreach ($cinemas as $cinema)
                                            <option value="{{ $cinema -> id }}">@foreach ($citys as $city)
                                                @if ($city -> code == $cinema->cluster_cinema -> city_id )
                                                    {{ $city -> name }}
                                                @endif
                                            @endforeach - {{ $cinema->cluster_cinema -> name }} - {{ $cinema -> name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-xl-6">
