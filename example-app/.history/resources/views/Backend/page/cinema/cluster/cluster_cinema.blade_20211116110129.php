                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg-{{ $cluster_cinema -> id }}" tabindex="-1" role="dialog"
                                        aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                {{--  --}}
                                                        ...
                                                        <form action="{{ route('cinema.cluster.create') }}" method="POST"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-9">
                                                                    <div class="form-group">
                                                                        <label for="">Tên rạp</label>
                                                                        <input value="{{ $cluster_cinema -> name }}" name="name" type="text"
                                                                            class="form-control  " placeholder="Tên rạp">
                                                                        <x-error field="name" class="text-danger" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <img style=" width:150px ; height : 150px ; border-radius:50%"
                                                                            class="showImg_2_{{ $cluster_cinema -> id  }}" src="{{ URL::to('images/cinema/' . $cluster_cinema -> logo) }}">
                                                                        <input type="file" name="logo" id="" data-id="{{ $cluster_cinema -> id }}"
                                                                            class="form-control"
