                    ...
                    @foreach ($cluster_cinemas as $key => $cluster_cinema)
                        <tr>
                            ...
                            <td>
                                {{-- Updated --}}
                                <div>
                                    <button type="button" class="btn btn-success rounded-xl" data-toggle="modal"
                            ...
                            <td>
                                <form action="{{ route('cinema.cluster.delete', ['id' => $cluster_cinema->id]) }}"
                                    ...
                                    @csrf
                                    @method('delete')
                                    <button onclick="return confirm(' Bạn có có chắc chắn không')" type="submit" class="btn btn-danger">Xóa</i></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
