    ...
    <div class="bg-success p-3 text-light rounded-2xl col-sm-12"  >
        ...
        <p>Tình trạng :
            ...
            @elseif ($receipt -> user_view_success == 2)
                <a href="#" class="badge badge-primary">Khách hàng gặp vấn đề</a>
            @elseif ($receipt -> user_view_success == 3)
                <a href="#" class="badge badge-primary">Khách hàng đang xác nhận</a>
            @else
                 <a href="#" class="badge badge-primary">Đã hết hạn !</a>
            @endif
        </p>
    </div>
</div>
