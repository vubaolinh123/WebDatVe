    ...
    <div style="margin-bottom : 20px ; border-radius : 20px ; box-shadow:2px 2px 20px #85ff00,2px 2px 20px black" class="bg-success p-3 text-light rounded-2xl col-sm-12"  >
        ...
        <p>Tình trạng :
            ...
            @elseif ($receipt -> user_view_success == 2)
                ...
                <br>
                <br>
                <button id="res_del" class="btn  btn-info">Hoàn trả tiền</button>
                <button id="reset_receipt" class="btn btn-danger">Khách hàng có hành vi gian lận , thẻ sẽ về trạng thái ban đầu</button>
