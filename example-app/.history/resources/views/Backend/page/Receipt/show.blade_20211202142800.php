...
<div class="row">
    ...
    <div style="margin-bottom : 20px ; border-radius : 20px ; box-shadow:2px 2px 20px #85ff00,2px 2px 20px black" class="bg-success p-3 text-light rounded-2xl col-sm-12"  >
  ...
  <!-- Modal -->
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-id="{{ $receipt -> id_receipt }}" id="res_del" >Hoàn trả tiền</button>
                <button data-id="{{ $receipt -> id_receipt }}" id="reset_receipt" class="btn btn-danger">Khách hàng có hành vi gian lận , thẻ sẽ về trạng thái ban đầu</button>
    ...
    <div class="  col-sm-6"  >
        <div style=" border-radius : 20px ; box-shadow:2px 2px 20px #85ff00,2px 2px 20px black"  class="bg-success p-3 m-2">
            <h2>Đồ ăn</h2>
