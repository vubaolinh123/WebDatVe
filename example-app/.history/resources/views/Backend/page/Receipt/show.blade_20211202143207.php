            ...
            <p>Tình trạng :
                ...
                @elseif ($receipt -> user_view_success == 2)
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <textarea name="" class="form-control textarea" id="textarea" placeholder="Lý do hoàn tiền" id="" cols="30" rows="10"></textarea>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                                    <button type="button" id="res_del" class="btn btn-primary">Hoàn tiền</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                        data-id="{{ $receipt->id_receipt }}" >Hoàn trả tiền</button>
