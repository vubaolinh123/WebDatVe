        ...
        <table class="table table-hover">
            <thead class="thead-primary">
                <tr>
                    ...
                    <th scope="col">Thời gian xem phim</th>
                ...
                @foreach ($receipts as $receipt)
                   <tr>
                       <style>
                        ...
                        <td>
                            {{ $receipt -> showtime -> cinema_room -> cinema -> name }}
                        </td>
                        ...
                        <td>
                            ...
                            @php
                                $dataT = '<b>'.$data ?? '0'.'</b>';
                                $strT = '<p>'. $receipt -> total . '</p>';
                            @endphp
                                 {!!  (str_replace($data ?? '0', $dataT , $strT)) !!}
                            @else
                                 {!!  $receipt -> total !!}
                            @endif
                             .VND
                        ...
                        @elseif($receipt ->showtime -> show_date < \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toDateString()
                            ...
                            <span class=" alert-danger">{{ 'Đã hết hạn' }}</span>
                            <form
                                method="POST"
