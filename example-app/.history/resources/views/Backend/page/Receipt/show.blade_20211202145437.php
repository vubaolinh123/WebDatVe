                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" action="{{ route('admin.receipt.change_pay') }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <textarea name="content_pass" class="form-control textarea" id="textarea_pass" placeholder="Lý do hoàn tiền" id="" cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
                                        <button type="submit"  data-id="{{ $receipt->id_receipt }}"  id="res_del" class="asasas btn btn-primary">Hoàn tiền</button>
                                    </div>
                                </form>
                            </div>
                        </div>
