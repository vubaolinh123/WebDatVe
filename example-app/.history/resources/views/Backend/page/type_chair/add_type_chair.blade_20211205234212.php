                    ...
                    <div class="basic-form">
                        <form id="add_type_chair" action="{{ route('admin.typechair.addSave') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control  " placeholder="Tên loại vé">
                            </div>
                            <div class="form-group">
                                <label for="">Ghi chú loại vé</label>
                                <input name="detail" type="text" class="form-control  " placeholder="Ghi chú loại vé">
                            </div>
                            <div class="form-group">
                                <label for="">Giá loại vé</label>
                                <input name="unit_price" type="text" class="form-control  " placeholder="Giá loại vé">
                            </div>
                            <div class="form-group">
