                    ...
                    <div class="basic-form">
                        <form id="add_type_chair" action="{{ route('admin.typechair.addSave') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name_chair" type="text" class="form-control  " placeholder="Tên thể loại">
                            </div>
                            <div class="form-group">
                                <label for="">Giá loại ghế</label>
                                <input name="price_chair" type="text" class="form-control  " placeholder="Tên thể loại">
                            </div>
