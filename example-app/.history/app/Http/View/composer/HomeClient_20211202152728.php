...
class HomeClient
{
    ...
    public function compose( View $view)
    {
        ...
        $cinemas = Cinema::where('city_id', Session::get('cityAddress'))->get();
        $filmHomeDeleted1s = $this -> film::inRandomOrder()->where('status', 0)->where('deleted', 1)
            ...
            ->get();
        return $view -> with(['filmHomeDeleted0s' => $arrFilm , 'cinemas' => $cinemas , 'filmHomeDeleted1s' => $filmHomeDeleted1s]);
    }
}
