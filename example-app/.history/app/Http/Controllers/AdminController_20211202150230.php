...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $receipts = Receipt::where('date_pay' , '>=' , $dt->subMonths(1))->where('user_view_success' , '<' , 4)->get();
        ...
        $sumPriceOneDay = (Receipt::where('date_pay','>=',$dtNow)->get()->sum('total'));
        $sumPriceMonth = (Receipt::where('date_pay','>=',$dtMonth) ->sum('total'));
