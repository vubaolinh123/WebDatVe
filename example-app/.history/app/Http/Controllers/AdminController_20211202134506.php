...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $dtMonth = Carbon::now('Asia/Ho_Chi_Minh');
        ...
        // dump($dtNow -> subDays(1) -> toDateTimeString());
        // dd(Receipt::where('date_pay','>=',$dtNow -> subDays(1)-> toDateTimeString())->get());
        $sumPriceOneDay = (Receipt::where('date_pay','>=',$dtNow -> subDays(2)-> toDateTimeString())->get()->sum('total'));
        $sumPriceMonth = (Receipt::where('date_pay','>=',$dtMonth->subDays(30))->sum('total'));
