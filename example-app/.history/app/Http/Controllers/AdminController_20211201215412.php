...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        foreach($arrSave  as $k => $v){
            $data = Showtime::where('id_showtime',$k)->get();
        ...
        return view('Backend.page.dashboard.home_admin',['arrSave' => $arrSave, 'countChair' => $countChair,'countBuy' => $countBuy,'sumPriceMonth' => $sumPriceMonth,'sumPrice' => $sumPrice,'sumPriceOneDay' => $sumPriceOneDay]);
    }
