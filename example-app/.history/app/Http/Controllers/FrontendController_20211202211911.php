...
class FrontendController extends Controller
{
    ...
    public function select_cinema_ajax(Request $request)
    {
        ...
        foreach($cinema -> cinema_room as $cinema_r){
            foreach($cinema_r -> showtimeNow as $showtime){
            ?>
                <option value="<?= $showtime->id_showtime ?>">Ngày : <?= $showtime -> show_date ?> - Thời gian :
                <?= date('h:i' , strtotime($showtime -> start_time )) ?> </option>
            <?php
            }
        }
    }
