...
class Receipt extends Controller
{
    ...
    public function render_list(Request $request)
    {
        ...
        $showtimes = Showtime::where('show_date', $now )->get();
        ...
        //
        $render = view('Backend.page.receipt.render-list',['receipts' => $receiptsNew ,'showtimes' => $showtimes , 'data' => ( $request -> data ?? 0) ]) -> render();
        return $render;
    }
