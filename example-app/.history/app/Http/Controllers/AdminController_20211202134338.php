...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        dump($dtNow -> subDays(2) -> toDateTimeString());
        dd(Receipt::where('date_pay','>=',$dtNow -> subDays(2)-> toDateTimeString())->get());
        $sumPriceOneDay = (Receipt::where('date_pay','>=',$dt -> subDays(2)-> toDateTimeString())->get()->sum('total'));
