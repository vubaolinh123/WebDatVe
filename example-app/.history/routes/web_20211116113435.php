...
Route::middleware(['hasAdmin'])->group(function () {
    Route::prefix('/admin')->group(function () {
        ...
        Route::prefix('cinema')->group(function () {
            ...
            Route::post('/created', [ClusterCinema::class, 'store'])->name('cinema.create');
            Route::delete('/delete/{id}', [ClusterCinema::class, 'destroy'])->name('cinema.delete');
            Route::put('/updated/{id}', [ClusterCinema::class, 'update'])->name('cinema.updated');
        });
