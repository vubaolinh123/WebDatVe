            ...
            <div class="w-full h-600px bg-white px-5 py-10">
                <div class="w-10/12 my-0 mx-auto ">
                    <div class="grid grid-cols-12 gap-y-3 gap-x-5">
                        <!-- ROW 1  -->
                        <div class="border border-black text-center">A</div>
                        <div class="col-span-10">
                            <!-- CÁC HÀNG TỪ 1 - 12 -->
                            <div class="grid grid-cols-12 gap-x-1">
                                @for ($i = 0; $i < $show_time->cinema_room->quantity_row; $i++)

                                <div class="border border-black text-center bg-gray-400">{{ $i }}</div>
                                @endfor
                            </div>
                            <!-- END 1 - 12 -->
                        </div>
