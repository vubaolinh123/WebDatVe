...
class FrontendController extends Controller
{
    ...
    public function detailFim(Request $request,$id_film)
    {
        ...
        dd($film->showtime->where('show_date',$time)->query()->where('star_time'  , Carbon::now('Asia/Ho_Chi_Minh')->toTimeString() ) );

        foreach ($film->showtime->where('show_date',$time)->whereTime('star_time' , '<=' , Carbon::now('Asia/Ho_Chi_Minh')->toTimeString() ) as $room){
