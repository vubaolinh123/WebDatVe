                        ...
                        <tbody>
                            <tr style="width: 350px;">
                                ...
                                <td class="input-type">
                                    ...
                                    <input class="sl" type="number" min="0" value="0" name="s1" onchange="updateSL(0)">
                                    <span class="input-group input-booking">
                                ...
                                <td style="text-align: right;"><input type="text" readonly class="gia" value="65000"></td>
                            ...
                            <tr style="width: 350px;">
                                ...
                                <td class="input-type">
                                    ...
                                    <td style="text-align: right;"><input type="text" readonly class="gia gia1"  value="65000"></td>
                                ...
                                <tr style="width: 350px;">
                                    ...
                                    <input class="sl" type="number" min="0" value="0" name="s1" onchange="updateSL(1)">
                                    <span class="input-group input-booking">
                        ...
                        <table id="table-combo">
                            ...
                            <tbody>
                                <tr style="text-align: center;">
                                    ...
                                    <input class="sl" type="number" min="0" value="0" name="s1" onchange="updateSlcombo(0)">
                                    <span class="input-group input-booking">
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td class="input-type">
                                    ...
                                    <td style="text-align: right;"><input type="text" readonly class="gia gia2"  value="65000"></td>
                                ...
                                <tr  style="text-align: center;">
                                    ...
                                    <input class="sl" type="number" min="0" value="0" name="s1" onchange="updateSlcombo(1)">
                                    <span class="input-group input-booking">
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td class="input-type">
                                    ...
                                    <td style="text-align: right;"><input type="text" readonly class="gia gia2"  value="65000"></td>
                                    <td id="tongtien" style="text-align: right;"><labe  class="tt tongItem2"></labe></td>
                                </tr>
                                <tr  style="text-align: center;">
                                    <td class="table-combo-td">
                                        <img src="./img/combo-1.jpg" alt="">
                                    ...
                                    <input class="sl" type="number" min="0" value="0" name="s1" onchange="updateSlcombo(2)">
                                    <span class="input-group input-booking">
                                ...
                                <td id="tongtien" style="text-align: right;"><label class="tt"></td>
                                    ...
                                    <td style="text-align: right;"><input type="text" readonly class="gia gia2"  value="65000"></td>
                                    <td id="tongtien" style="text-align: right;"><labe   class="tt tongItem2"></td>
            ...
            <div class="detail-film">
                <div class="box-detail">
                    ...
                    <div class="ticket-price-total">
                        <p class="total-text">Tổng: <span class="money"><label id="tongtien3"></label></span></p>
                    </div>
                    <div class="view-more">
...
<script>
    ...
    function tongtien1() {
        ...
        document.getElementById('tongtien3').innerHTML = Number(document.getElementById("tongtien").innerHTML) + Number(document.getElementById("tongtien2").innerHTML)
